...
public class UserFacadeREST extends AbstractFacade<User> {
    ...
    public void create(User entity) {
        System.out.println("getActivityLevel" + entity.getActivityLevel() + "end");
        System.out.println("getStepsMile" + entity.getStepsMile() + "end");
...
//    }
    ...
    @GET
    @Path("checkUser/{name}/{password}")
    @Produces({MediaType.APPLICATION_JSON})
    public String checkUser(@PathParam("name") String name, @PathParam("password") String password) {
    ...
    @GET
    @Path("updateGoal/{id}/{goal}")
    @Produces({MediaType.APPLICATION_JSON})
    public User updateGoal(@PathParam("id") String id, @PathParam("goal") String goal) {
        User u = this.find(id);
        u.setGoal(Integer.valueOf(goal));
        this.edit(u);
        return this.find(id);
    }
